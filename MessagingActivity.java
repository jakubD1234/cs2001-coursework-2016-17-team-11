...
public class MessagingActivity extends Activity {
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName className) {
            imService = null;
            Toast.makeText(MessagingActivity.this, R.string.local_service_stopped,
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        if (message == -1) {
            ...
            return new AlertDialog.Builder(MessagingActivity.this)
                    .setMessage(message)
    ...
    protected void onResume() {
        super.onResume();
        bindService(new Intent(MessagingActivity.this, IMService.class), mConnection, Context.BIND_AUTO_CREATE);
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("Messaging Page") // TODO: Define a title for the content shown.
