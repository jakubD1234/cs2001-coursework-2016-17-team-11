...
*/
    ...
    public String sendMessage(String  username, String  tousername, String message , String picname , String Key) throws UnsupportedEncodingException
    {
        if(picname==null)
            picname="";
        if(Key==null)
    ...
    private String getMessageList() throws UnsupportedEncodingException 	{
        ...
        if (rawMessageList != null) {
            ...
            //       System.err.println(rawMessageList);
    ...
    public void messageReceived(String username, String message, String picname)
    {
        ...
        if ( msg != null)
        {
            ...
            i.putExtra(MessageInfo.PICName, msg.picname);
            sendBroadcast(i);
            String activeFriend = FriendController.getActiveFriend();
            if (activeFriend == null || activeFriend.equals(username) == false)
            {
                localstoragehandler.insert(username,this.getUsername(), message.toString(), picname.toString() ,null);
                           ...
                           FriendInfo[] unApprovedFriends, String userKey)
    {
        ...
        while (i < messages.length){
            messageReceived(messages[i].userid,messages[i].messagetext, messages[i].picname);
